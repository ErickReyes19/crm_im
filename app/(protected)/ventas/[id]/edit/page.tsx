...
export default async function EditVentaPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const clienteActualDisponible = clientes.some((cliente) => cliente.id === venta.clienteId);
