...
export default async function CreateVentaPage() {
  ...
  const initialData = { clienteId: clientes[0]?.id ?? "", total: 0, isv: 0, tipoDocumento: "RECIBO" as const, conEnvio: false, envio: 0, estado: "PROCESO" as const, metodoPago: "EFECTIVO" as const, evidenciaTransferenciaUbicacion: "", evidenciaTransferenciaNombre: "", productos: [{ productoId: productos[0]?.id ?? "", cantidad: 1, precioUnitario: 0, tipoPrecio: "NORMAL" as const }] };
