  ...
  return (
    <div className="rounded-md border p-4">
      <div className="flex flex-col items-center justify-between gap-3 py-4 md:flex-row">
        <Input placeholder="Filtrar tareas" value={globalFilter} onChange={(event) => setGlobalFilter(event.target.value)} className="w-full md:max-w-sm" />
        <Button asChild className="w-full md:w-auto">
          <Link href="/tareas/create" className="flex items-center gap-2">Nueva tarea <Plus /></Link>
        </Button>
      </div>
